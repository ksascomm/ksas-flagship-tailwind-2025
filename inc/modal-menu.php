	...
	<div class="menu-modal-inner modal-inner">
		...
		<div class="menu-wrapper section-inner">
			...
			<div class="menu-top">
				...
				<button class="toggle close-nav-toggle fill-children-current-color mt-16" data-toggle-target=".menu-modal" data-toggle-body-class="showing-menu-modal" data-set-focus=".menu-modal">
