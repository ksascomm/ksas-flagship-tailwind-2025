	...
	<div class="max-w-[95vw] w-full px-6 mx-auto xl:mx-20">
		<div class="grid grid-cols-1 gap-6 pt-8 site-info lg:grid-cols-2">
			<div class="flex justify-center lg:justify-start">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/dist/images/krieger.logo.cropped.svg" class="w-[66%] md:w-[40%] lg:w-[60%] xl:w-[45%] 2xl:w-[35%] h-auto xl:p-5" alt="KSAS Shield, to the homepage">
			</div>
			<!-- Shield -->
			<div class="flex flex-wrap justify-center lg:pt-6 lg:justify-end lg:ml-40">
			...
			<!-- Legal Stuff -->
			<div class="mx-auto mt-8 text-center col-span-full">
			...
			<ul class="flex flex-wrap justify-center" role="menu" aria-label="University Policies" id="footer-quicklinks-2">
				<li class="pl-3 pr-2" role="menuitem"><a class="font-sans text-white font-regular" href="https://accessibility.jhu.edu/">Accessibility</a> <i class="fa-solid fa-arrow-up-right-from-square"></i></li>
				<li class="px-2" role="menuitem"><a class="font-sans text-white font-regular" href="https://it.johnshopkins.edu/policies/privacystatement">Privacy Statement</a> <i class="fa-solid fa-arrow-up-right-from-square"></i></li>
